                    ...
                    <div>
                        ...
                        <div class="flex  ">
                            ...
                            <div class="  w-full sm:w-1/2 lg:w-1/3 p-5">
                                ...
                                <div><i class="fa-solid fa-certificate font-13 pl-1 text-gold"></i> تضمین به روز بودن قیمت
                                    طلا</div>
                                <div><i class="fa-solid fa-gift text-blue  font-13 pl-1"></i> فاکتور + پکیج هدیه</div>

                                @if (isset($detail->attr['in-stock']) && $detail->attr['in-stock'] == 0)
                                    <div class="bg-red-600 text-white p-1 rounded-md border-red-600 border mt-1">ناموجود:
                                ...
                                <div class="bg-gray border p-2 border-radius-5">
                                    ...
                                    @isset($detail->attr['weight'])
                                        <div class="flex one">
                                            ...
                                            <div class="font-15 p-3 text-center bold text-green">قیمت @convertCurrency($detail->GoldPrice()['totalPrice']) تومان</div>
