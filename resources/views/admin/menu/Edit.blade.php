                    ...
                    <div class="col-md-5">
                        ...
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-default">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse {{ $menu_info->module == 'category' ? 'in' : '' }}" role="tabpanel"
                                     aria-labelledby="headingOne">
                                    <div class="panel-body">
                                        <form action="{{ route('menu.update', $menu_info->id) }}" method="POST" name="add_content"
                                            ...
                                            <div class="col-md-12">
                                                <div class="panel-title">
                                                    ...
                                                    <select name="parent" id="parent"  class="parent" {{--class="form-control"--}}>
                                                        <option value="0" {{ $menu_info->parent == 0 ? 'selected' : '' }}>no parent</option>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse {{ $menu_info->type == 'external' ? 'in' : '' }}" role="tabpanel"
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingThree">
                                    ...
                                    <div id="collapseThree" class="panel-collapse collapse {{ $menu_info->type == 'single_page' ? 'in' : '' }}" role="tabpanel"
                                        ...
                                        <form action="{{ route('menu.update', $menu_info->id) }}" method="POST" name="add_content"
                                            ...
                                            <div class="col-md-12">
                                                <div class="panel-title">
                                                    ...
                                                    <select name="link"
                                                            id="anchor_link" class="anchor_link" {{--class="form-control"--}}>
