            ...
            <div class="panel-body full-height">
                <form method="post" action="{{ route('contents.update', $content_info->id) }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <textarea rows="5" class="form-control" id="append_header'"
                                name="attr[append_header]">{{ old('attr[append_header]', $content_info->attr['append_header']) }}</textarea>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <textarea rows="30" class="form-control" id="description"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <textarea rows="5" class="form-control" id="append_footer'"
                                name="attr[append_footer]">{{ old('attr[append_footer]', $content_info->attr['append_footer']) }}</textarea>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-6">
                            <label for="images" class="control-label">تصویر مقاله (سایز مقاله
                                {{ env('ARTICLE_LARGE') }}px) (سایز محصول {{ env('PRODUCT_LARGE') }}px)</label>
