            ...
            <div class="flex one two-500 two-800 center ">
                ...
                <form action="{{ route('search') }}" class="p-0">
                    ...
                    <input name="q" autocomplete="off" id="q" alt="جستجو" type="text"
                        ...
                        oninvalid="this.setCustomValidity('کلمه ای برای جستجو تایپ کنید')"
                        onchange="this.setCustomValidity('')">

                    <button class=""><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                            width="24" height="24" viewBox="0 0 32 32" style=" fill:#000000;">
                            <path
        ...
        <div class="flex two five-500  center ">
            ...
            @if (isset($banners) && isset($banners['images']))
                @foreach ($banners['images'] as $k => $content)
                    <a href="{{ $banners['url'][$k] }}" @if (!isset($banners['follow'][$k])) rel="nofollow" @endif
                        target="blank">
...
<section class="index-item-top bg-blue2 mt-0 mb-0">
    ...
    <div class="flex one two-500 three-700 four-900 center  ">
        ...
        @isset($category['data'])
            ...
            <a class="bg-theme4 btn border-radius-5 white-space-nowrap text-center"
                href="{{ url('/سوئیچ-و-ریموت-خودرو') }}">مشاهده بیشتر سوئیچ و ریموت</a>
        @endisset
    </div>
</section>
...
<section class="index-item-top bg-gray2 mt-0 mb-0">
    ...
    <div class="flex two three-500 six-1000 center  ">
        ...
        @php
            $auto = \App\Models\Category::find(215)?->companiesCategory()
                ->limit(6)
                ->get();
        @endphp
                    ...
                    <div class="shadow hover h-100">
                        ...
                        @if (isset($content->logo))
                            <picture>
                                ...
                                <img src="{{ $content->logo['medium'] ?? '' }}" alt="{{ $content->title }}"
                                    width="{{ env('COMPANY_MEDIUM_W') }}" height="{{ env('COMPANY_MEDIUM_W') }}">
                            </picture>
                        @endif
...
<section class="index-item-top bg-gray mt-0 mb-0">
    ...
    <div class="flex two three-500 six-1000 center  ">
        ...
        @php
            $auto = \App\Models\Category::find(216)?->companiesCategory()
                ->limit(6)
                ->get();
        @endphp
...
<section class="index-item-top bg-gray2 mt-0 mb-0">
    <div class="text-center pb-1">
        <h2>کارشناسی خودرو </h2>
    </div>
    <div class="flex two three-500 six-1000 center  ">


        @php
            $auto = \App\Models\Category::find(285)?->companiesCategory()->limit(6)->get();
