...
@section('meta-title', $detail->title . ' | طرح و وب')
...
@section('Content')
    ...
    <section class="webdevelopment-custom-package">
        <div class="flex one two-500  center align-center">
            <div>
                ...
                <p>شما می توانید بر اساس نیاز شرکت و موسسه خود، یا برای کسب و کار تجاری خود سایت و نرم افزاری طراحی کنید که
                    متناسب با فعالیت شما باشد. هدف طرح و وب ایجاد پلتفرم های تحت وب برای سهولت انجام پروسه های کاری شما می
                    باشد. ایجاد وب سایت مدارس، پرتال دانشگاهی، واسطه گری مالی، ERP و طراحی سایت سفارشی از جمله فعالیت ماست.
                </p>
    ...
    <section class="package-info pb-4 pt-4">
        <div class="flex one two-500 three-900 center align-center">
            <div>
                <h2>واکنشگرا</h2>
                <p>وب سایت های ما 100٪ سازگار به موبایل هستند، بنابراین اطمینان حاصل می کنند که در هر دستگاه عملکرد خوبی
                    دارد.</p>
            </div>

            <div>
                <h2>سئو</h2>
                <p>تیم مشاوران SEO به عنوان افرادی مناسب که می توانند فرصت ها ، اهداف و اهداف را شناسایی کنند. آنها می
                    توانند به شما در دستیابی به یک راهبرد استراتژیک و عملکرد و رتبه بندی موثر وب سایت خود کمک کنند.</p>
            </div>
            ...
            <div>
                ...
                <p>همه بسته های وب سایت ما برای سرعت اجرا بهینه ساخته شده اند! این شماره 1 در لیست چک های Googles است تا
                    اطمینان حاصل شود که وب سایت شما به خوبی رتبه بندی شده است.</p>
            </div>
            <div>
                <h2>مدیریت محتوا</h2>
            ...
            <div>
                <h2>طراحی سفارشی</h2>
                <p>ما اشتیاق به طراحی داریم و از این رو می خواهیم مشتری هایمان وب سایتی داشته باشند که نشان دهنده نام تجاری
                    و دیداری منحصر به فرد باشد.
                </p>
            </div>
