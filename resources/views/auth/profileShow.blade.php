                        ...
                        <div class="flex one two-700 three-1100 four-fifth ">
                            ...
                            @if ($company->mobile != '')
                                <div class="">@lang('messages.mobile'):
                                    <span  style="display: inline-block" class="text-editor" data-field="mobile"
                            ...
                            @if ($company->site != '')
                                <div class="">@lang('messages.site'):
                                    <span class="text-editor" data-field="site"
                                        data-label="@lang('messages.site')">
                                        <a href="{{ $company->site }}" rel="nofollow" target="_blank">{{  str_replace(['http://','https://'],'',$company->site ?? '') }}</a>
                                        </span>
                                </div>
                            @endif
                            ...
                            @if ($company->telegram != '')
                                <div class="">@lang('messages.telegram'): <span class="text-editor" data-field="telegram"
                                        data-label="@lang('messages.telegram')">
