...
<section class="banner my-0 py-0">
    <div class="flex one max-w-max">
        <img class="h-auto p-0" srcset="{{ url('eden/img/banner-mom-mob.jpg') }} 800w, {{ url('eden/img/banner-mom.jpg') }} 1200w, {{ url('eden/img/banner-mom.jpg') }} 1800w" src="{{ url('eden/img/banner-mom-mob.jpg') }}" alt="طلای ایدن" title="طلای ایدن" width="1200" height="344">
        ...
        <div class="siema p-0">
            ...
            <a href="{{ $content->slug }}">
                <div class="hover text-center">
                    ...
                    <figure class="image">
                        <img loading="lazy" src="{{ $content->images['images']['small'] }}" alt="{{ $content->title }}" width="61" height="79" srcset="
        ...
        <div class="flex one three-500 p-0">
            ...
            <div class="two-third-500 p-0 ">
                <div class="flex on three-500  h-full p-0 text-center  home-items">
                    <div class="p-0 align-items-center"><span class="p-0 bg-theme-color2 third-500 border-radius-5 w-1">1</span>
                        <div class="font-09"> خرید طلا بدون واسطه از طلا ساز</div>
                    </div>
                    <div class="p-0 align-items-center"><span class="p-0 bg-theme-color2 third-500 border-radius-5">2</span>
                        <div class="font-09">ضمانت اصالت محصول</div>
                    </div>
                    <div class="p-0 align-items-center"><span class="p-0 bg-theme-color2 third-500 border-radius-5">3</span>
...
<section class="category-section mt-1 mb-0 lg:my-10 ">
    <div class="relative  shadow p-0">
        ...
        <div class="flex two six-500 p-0 ">
            <a class="  p-0 bg-gray-dark cat1-home" href="/انگشتر-طلا-زنانه" style=" background-image:url({{ url('eden/img/دسته-بندی-انگشتر-طلا.jpg') }}) ">
                <div class="h-full">
