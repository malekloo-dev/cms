<div class="top-menu">
    ...
    <div class="bg-white border-b">
        <header class=' py-1 px-1 lg:px-0   min-h-[70px] '>
            <div class='flex flex-wrap items-center lg:gap-y-2 gap-y-4 gap-x-4 lg:gap-x-1'>
                <a href="/" class="">
                ...
                <div class='flex items-center mr-auto lg:order-1'>
                    ...
                    <a class="mr-6 " href="https://www.instagram.com/eden.gold.gallery/">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30px" class="cursor-pointer "
                            viewBox="0 0 24 24">
                    ...
                    <a class="mr-6 " target="__blank"
                        href="https://api.whatsapp.com/send?phone=989374599840&text=سلام.%20میخواستم%20سفارش%20ثبت%20کنم">
                ...
                <ul id="collapseMenu"
                    class='lg:!flex lg:mr-5 lg:space-x-8 lg:space-x-reverse max-lg:space-y-2 max-lg:hidden max-lg:w-full max-lg:my-4'>
