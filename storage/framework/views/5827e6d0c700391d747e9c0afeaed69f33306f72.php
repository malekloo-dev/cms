...
$currentUrl="http://live-chat.local/harimayco";
						...
						<div class="wrap">
							...
							<div class="manage-menus">
								<form method="get" action="<?php echo e($currentUrl); ?>">
									...
									<?php echo \Harimayco\Menu\Facades\Menu::select('menu',$menulist); ?>
												...
												<div id="nav-menu-header">
													<div class="major-publishing-actions">
														<label class="menu-name-label howto open-label" for="menu-name"> <span>Name</span>
															...
															<input type="hidden" id="idmenu" value="1" />
														</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\xampp\htdocs\live-chat\resources\views/vendor/wmenu/menu-html.blade.php ENDPATH**/ ?>