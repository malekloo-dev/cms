...
<div class="content-body">
    <div class="panel panel-default mat-elevation-z pos-abs chat-panel bottom-0">
        <div class="panel-body full-height">
            <form method="post" action="<?php echo e(route('contents.update', $content_info->id)); ?>"enctype="multipart/form-data">
                ...
                <?php if($content_info->attr_type=='product'): ?>

                    <div class="form-group row">
                        <label for="brand" class="col-md-12 col-form-label text-md-left">Brand:</label>
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="attr[brand]" value="<?php echo e(old('attr[brand]',$content_info->attr['brand'])); ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="attr[price]" value="<?php echo e(old('attr[price]',$content_info->attr['price'])); ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="attr[offer_price]" value="<?php echo e(old('attr[offer_price]',$content_info->attr['offer_price'])); ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="attr[alternate_name]" value="<?php echo e(old('attr[alternate_name]',$content_info->attr['alternate_name'])); ?>"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="attr[rate]" value="<?php echo e(old('attr[rate]',$content_info->attr['rate'])); ?>"/>
                        </div>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\xampp\htdocs\live-chat\resources\views/content/edit.blade.php ENDPATH**/ ?>