                ...
                <table class="table table-striped">
                    ...
                    <?php $__currentLoopData = $contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo $content->symbol. $content->title; ?></td>
                            ...
                            <td class="width-80">
                                <div class="row">
                                    <div class="col-xs-6">
                                        <form class=" width-30 height-30 line-height-30" action="<?php echo e(route('category.destroy', $content->id)); ?>" method="post">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-xs-6">
                                        <a href="<?php echo e(route('category.edit',$content->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\xampp\htdocs\live-chat\resources\views/category/list.blade.php ENDPATH**/ ?>