<aside class="side-left full-height pos-abs right-0 left-0 bottom-0 disBlock padding-t-full">
    <ul class="sidebar no-margin no-padding">
        ...
        <li class="no-margin">
            <a class="no-margin text-left" href="<?php echo e(route('bots.index')); ?>">
    ...
    <p class="copyright-container text-left pos-abs bottom-0 right-0 left-0 padding-full no-margin text-white">&copy; <?php echo e(date('Y')); ?> Abatalk.</p>
</aside><?php /**PATH O:\xampp\htdocs\live-chat\resources\views/sidebar.blade.php ENDPATH**/ ?>