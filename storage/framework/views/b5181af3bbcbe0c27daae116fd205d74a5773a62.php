...
<head>
    ...
    <link href="<?php echo e(asset('packages/garcia/wmenu/menu/style.css')); ?>" rel="stylesheet">
...
<div id="wpwrap">
    <div id="wpcontent">
        <div id="wpbody">
            <div id="wpbody-content">
                ...
                <div class="wrap">
                    <h2 class="nav-tab-wrapper"><a href="<?php echo e(route('wmenuindex')); ?>" class="nav-tab nav-tab-active">Edit Menu</a><!---<a href="<?php echo e(route('wmenuindex')); ?>?action=locations" class="nav-tab">Gestionar lugares</a>--></h2>
                    <div class="manage-menus">
                        <form method="get" action="<?php echo e(route('wmenuindex')); ?>">
                            <label for="menu" class="selected-menu">Select the menu you want to edit:</label>

                            <?php echo e(Form::select('menu', $menulist,0)); ?>


                            <span class="submit-btn">
										<input type="submit" class="button-secondary" value="Choose">
									</span>
                            <span class="add-new-menu-action"> or <a href="<?php echo e(route('wmenuindex')); ?>?action=edit&menu=0">Create new menu</a>. </span>
                        </form>
                    </div>
                    <div id="nav-menus-frame">

                        <?php if(Input::has('menu')): ?>
                                                    ...
                                                    <li id="menu-item-<?php echo e($m->id); ?>" class="menu-item menu-item-depth-<?php echo e($m->depth); ?> menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
                                                        <dl class="menu-item-bar">
                                                            <dt class="menu-item-handle">
                                                                ...
                                                                <span class="item-controls"> <span class="item-type">Link</span> <span class="item-order hide-if-js"> <a href="<?php echo e(route('wmenuindex')); ?>?action=move-up-menu-item&menu-item=<?php echo e($m->id); ?>&_wpnonce=8b3eb7ac44" class="item-move-up"><abbr title="Move Up">↑</abbr></a> | <a href="<?php echo e(route('wmenuindex')); ?>?action=move-down-menu-item&menu-item=<?php echo e($m->id); ?>&_wpnonce=8b3eb7ac44" class="item-move-down"><abbr title="Move Down">↓</abbr></a> </span> <a class="item-edit" id="edit-<?php echo e($m->id); ?>" title=" " href="<?php echo e(route('wmenuindex')); ?>?edit-menu-item=<?php echo e($m->id); ?>#menu-item-settings-<?php echo e($m->id); ?>"> </a> </span>
                                                            </dt>
                                                        </dl>
                                                        ...
                                                        <div class="menu-item-settings" id="menu-item-settings-<?php echo e($m->id); ?>">
                                                            ...
                                                            <p class="field-css-classes description description-wide">
                                                                <label for="edit-menu-item-classes-<?php echo e($m->id); ?>"> Url
                                                                    <br>
                                                                    <input type="text" id="url_menu_<?php echo e($m->id); ?>" class="widefat code edit-menu-item-classes" id="url_menu_<?php echo e($m->id); ?>" value="<?php echo e($m->link); ?>">
                                                                </label>
                                                            </p>

                                                            <p class="field-move hide-if-no-js description description-wide">
                                                                <label> <span>Move</span> <a href="<?php echo e(route('wmenuindex')); ?>?action=edit&menu=26#" class="menus-move-up" style="display: none;">Move up</a> <a href="<?php echo e(route('wmenuindex')); ?>?action=edit&menu=26#" class="menus-move-down" title="Mover uno abajo" style="display: inline;">Move Down</a> <a href="<?php echo e(route('wmenuindex')); ?>?action=edit&menu=26#" class="menus-move-left" style="display: none;"></a> <a href="<?php echo e(route('wmenuindex')); ?>?action=edit&menu=26#" class="menus-move-right" style="display: none;"></a> <a href="<?php echo e(route('wmenuindex')); ?>?action=edit&menu=26#" class="menus-move-top" style="display: none;">Top</a> </label>
                                                            </p>

                                                            <div class="menu-item-actions description-wide submitbox">

                                                                <a class="item-delete submitdelete deletion" id="delete-<?php echo e($m->id); ?>" href="<?php echo e(route('wmenuindex')); ?>?action=delete-menu-item&menu-item=<?php echo e($m->id); ?>&_wpnonce=2844002501">Delete</a>
                                                                <span class="meta-sep hide-if-no-js"> | </span>
                                                                <a class="item-cancel submitcancel hide-if-no-js button-secondary" id="cancel-<?php echo e($m->id); ?>" href="<?php echo e(route('wmenuindex')); ?>?edit-menu-item=<?php echo e($m->id); ?>&cancel=1424297719#menu-item-settings-<?php echo e($m->id); ?>">Cancel</a>
                                                                <span class="meta-sep hide-if-no-js"> | </span>
    ...
    <script type="text/javascript" src="<?php echo e(asset('packages/garcia/wmenu/menu/scripts.js')); ?>"></script>

    <script type="text/javascript" src="<?php echo e(asset('packages/garcia/wmenu/menu/scripts2.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('packages/garcia/wmenu/menu/menu.js')); ?>"></script>
    ...
    <script>
        ...
        var menuwr="<?php echo e(route('wmenuindex')); ?>";
    </script>
    <div class="clear"></div>
</div>
...
</html><?php /**PATH O:\xampp\htdocs\live-chat\resources\views/vendor/wmenu/menu-html2.blade.php ENDPATH**/ ?>