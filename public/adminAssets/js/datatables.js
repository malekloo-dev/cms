	...
	"bs_two_button": {
		"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
		{
			...
			var sAppend = '<ul class="pagination">'+
				'<li class="prev"><a class="'+oSettings.oClasses.sPagePrevDisabled+'" tabindex="'+oSettings.iTabIndex+'" role="button"><span class="fa fa-angle-left"></span>&nbsp;'+oLang.sPrevious+'</a></li>'+
				'<li class="next"><a class="'+oSettings.oClasses.sPageNextDisabled+'" tabindex="'+oSettings.iTabIndex+'" role="button">'+oLang.sNext+'&nbsp;<span class="fa fa-angle-right"></span></a></li>'+
				'</ul>';
		...
		"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				$(nPaging).append(
					...
					'<li><a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageNext+'">'+oLang.sNext+'&nbsp;<span class="fa fa-angle-right"></span></a></li>'+
					'<li><a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageLast+'">'+oLang.sLast+'&nbsp;<span class="fa fa-angle-double-right"></span></a></li>'+
					'</ul>'
				);
				var els = $('a', nPaging);
				var nFirst = els[0],
...
if ( $.fn.DataTable.TableTools ) {
	...
	$.extend( true, $.fn.DataTable.TableTools.classes, {
		"container": "DTTT btn-group btn-group-sm pull-right",
		"buttons": {
